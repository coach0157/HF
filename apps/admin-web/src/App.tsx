...
import { BlockedVisitorsPage } from './pages/BlockedVisitorsPage';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/patrol-logs" element={<PatrolLogsPage />} />
          <Route path="/blocked-visitors" element={<BlockedVisitorsPage />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
