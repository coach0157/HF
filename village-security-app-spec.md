...
2. **เฟส 2:** แชท, ทำเนียบรถรับจ้าง/เรียกรถโดยสาร, แจ้งซ่อม
...
- **หน้าแรก (Home)**
  ...
  - การ์ดลัด 2x3: "เชิญแขก (QR)" / "แจ้งซ่อม" / "จองพื้นที่" / "ชำระค่าส่วนกลาง" / "เรียกรถโดยสาร" / "ประวัติเข้า-ออก"
...
### 2.7 ทำเนียบรถรับจ้าง / เรียกรถโดยสาร (Transport Directory) — เฟส 2

> แทนที่ "ทำเนียบลูกบ้าน" เดิม — ตามที่ตกลงกันใหม่ ไม่ทำ resident directory (ความเป็นส่วนตัว/ยินยอมซับซ้อนเกินความจำเป็นของ MVP) ให้ทำทำเนียบรถรับจ้างประจำหมู่บ้านแทน (วินมอเตอร์ไซค์/แท็กซี่หน้าหมู่บ้าน) — **ไม่ใช่การเชื่อม API เรียกรถจริงแบบ Grab/Bolt** แค่เป็นสมุดเบอร์โทรที่แอดมินดูแล ให้ลูกบ้านกดโทรออกเอง

**User Story:** ในฐานะลูกบ้าน ฉันต้องการดูรายชื่อ+เบอร์โทรวิน/แท็กซี่ที่หมู่บ้านแนะนำ เพื่อเรียกรถโดยสารได้สะดวกโดยไม่ต้องหาเบอร์เอง

**Acceptance Criteria:**
- แอดมินเพิ่ม/แก้ไข/ลบ/เปิด-ปิดการแสดงผล รายชื่อผู้ให้บริการรถรับจ้าง: ชื่อ/ชื่อเล่นคนขับ, ประเภท (วินมอเตอร์ไซค์/แท็กซี่/รถตู้/อื่นๆ), เบอร์โทร, พื้นที่ให้บริการ/หมายเหตุ (เช่น ราคาโดยประมาณ)
- ลูกบ้านดูรายการที่เปิดใช้งาน (active) ได้ พร้อมปุ่มโทรออกทันที (`tel:` link) — ไม่มีระบบจองคิว/ติดตามตำแหน่งรถ
- เรียงลำดับ/กรองตามประเภทได้พื้นฐาน (optional สำหรับ MVP ของโมดูลนี้)
...
| เฟส 2 | 4-6 สัปดาห์ | Chat, Transport Directory (เรียกรถโดยสาร), Maintenance Ticket |
